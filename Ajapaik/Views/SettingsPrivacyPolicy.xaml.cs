...
namespace Ajapaik.Views
{
    ...
    /// </summary>
    public sealed partial class SettingsPrivacyPolicy : Ajapaik.Common.LayoutAwarePage
    {

        Connect helper = new Connect();
        public SettingsPrivacyPolicy()
        {
            this.InitializeComponent();
            this.PrivacyPolicyTextBlock.Text = helper.getFromResourceFile("PrivacyPolicyText", "DataStrings");
