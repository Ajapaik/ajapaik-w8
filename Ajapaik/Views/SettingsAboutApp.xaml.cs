...
namespace Ajapaik.Views
{
    ...
    /// </summary>
    public sealed partial class SettingsAboutApp : Ajapaik.Common.LayoutAwarePage
    {
        Connect helper = new Connect();
        public SettingsAboutApp()
        {
            this.InitializeComponent();
            this.AboutAppTextBlock.Text = helper.getFromResourceFile("AboutAppText", "DataStrings");
        }
